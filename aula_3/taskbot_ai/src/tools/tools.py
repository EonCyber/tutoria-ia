...
def make_create_task_tool(google_tasks: GoogleTasks):
    ...
    def create_google_task(title: str, due: str) -> str:
        """
          Cria uma tarefa no Google Tasks e envia uma mensagem de confirmação via Telegram.
...
def get_today_date() -> str:
    """Retorna a data atual no formato ISO 8601 (UTC), ex: 2025-07-07T00:00:00Z, útil para saber o dia de hoje e qual data usar para criar tarefas."""
